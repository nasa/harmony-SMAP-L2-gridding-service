...
def transform_l2g_input(input_filename: Path, output_filename: Path) -> None:
    ...
    with open_datatree(input_filename, decode_times=False) as in_data:
        process_input(in_data, output_filename, str(input_filename))


def process_input(in_data: DataTree, output_file: Path, input_file_name: str = ''):
    ...
    root_dt = update_history_metadata(in_data, root_dt, input_file_name)
